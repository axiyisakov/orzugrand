...
abstract class $DeliveryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String dateTime, bool isChecked});
}
...
class _$DeliveryModelImpl implements _DeliveryModel {
  const _$DeliveryModelImpl(
      {required this.id, required this.dateTime, required this.isChecked});
  ...
  @override
  String toString() {
    return 'DeliveryModel(id: $id, dateTime: $dateTime, isChecked: $isChecked)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, dateTime, isChecked);
...
abstract class _DeliveryModel implements DeliveryModel {
  const factory _DeliveryModel(
      ...
      required final bool isChecked}) = _$DeliveryModelImpl;
